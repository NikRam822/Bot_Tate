...
public class UserStorage {
    private List<com.company.base.User> list = new ArrayList<>();
    private int userId;
    ...
    public void addUser(String name, String pas, int id) {
        list.add(new com.company.base.User(name, pas, id));
    }
    ...
    public List<com.company.base.User> getList() {
        return list;
    }
    ...
    public boolean isLoginDuplicate(String login) {
        boolean findUser = false;
        for (com.company.base.User e : list) {
    ...
    public void save() {
        try {
            ...
            for (com.company.base.User user : list) {
    ...
    upload() {
        try {
            ...
            System.out.println("Кол-во обьектов" + userSize);
            for (int i = 0; i < userSize; i++) {
                list.add((com.company.base.User) ois.readObject());
            }
            ois.close();
