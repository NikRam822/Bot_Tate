...
public class Group implements Serializable {
    ...
    private List<com.company.base.User> userList = new ArrayList<>();
    private String adminPassword;
    private List<com.company.base.User> admins = new ArrayList<>();
     ...
     */
    public void setAdmin(com.company.base.User user) {
        admins.add(user);
    }
     ...
     */
    public void invite(com.company.base.UserStorage userStorage, Group group, com.company.base.User sender, int[] idUsers) {
        for (int e : idUsers
        ) {
    ...
    public void setMessage(Message message) {
        for (com.company.base.User e : userList
        ) {
     ...
     * @return - true/false
     */
    public boolean isAdmin(com.company.base.User user) {
        boolean isAdmin = false;
        for (com.company.base.User e : admins
        ) {
            if (e.equals(user)) {
                return true;
            }
     ...
     * @param user - пользователь
     */
    public void addUser(com.company.base.User user) {
        userList.add(user);
    }
}
